  ...
  return (
    <div>
      <div className="container">
        <h4 className="u_font"> About Us </h4>
        <p className="p_font">
          ...
          build confidence.
          <br /> Through our website, we offer a unique opportunity for language
          ...
          <br /> Our user-friendly interface allows you to search for language
          partners based on your interests, proficiency level, and desired
          conversation topics. You can initiate conversations through text
          chats, voice calls, or even video calls, depending on your preference
          and comfort level. We also provide various discussion forums and
          language-related resources to further enhance your learning
          experience.
          <br />
          ...
          <br /> Start your language adventure now and become a part of our
          vibrant language learning community!
          <br /> Note: Please note that this is a sample text and can be
          modified or expanded upon to fit the specific context and goals of
          your language learning website.
        </p>
      </div>
    </div>
  );
